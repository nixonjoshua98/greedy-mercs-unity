...
public class ConditionalAttributeDrawer : PropertyDrawer
{
    ...
    {
        if (!ShowMe(property) && drawIf.disablingType == ConditionalAttribute.DisablingType.DontDraw)
        {
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        else if (drawIf.disablingType == ConditionalAttribute.DisablingType.ReadOnly)
        {
            GUI.enabled = false;
            EditorGUI.PropertyField(position, property, label);
            GUI.enabled = true;
